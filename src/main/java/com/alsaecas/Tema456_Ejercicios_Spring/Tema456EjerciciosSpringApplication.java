package com.alsaecas.Tema456_Ejercicios_Spring;

import com.alsaecas.Tema456_Ejercicios_Spring.controllers.LaptopController;
...
public class Tema456EjerciciosSpringApplication {

	public static void main(String[] args) {
		ApplicationContext context = SpringApplication.run(Tema456EjerciciosSpringApplication.class, args);
